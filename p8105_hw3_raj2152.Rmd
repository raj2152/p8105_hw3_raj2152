...
From the plot above, the mean ranking of overall health appears to hover around 20-25%.
...
The median values and interquartile range of self-reported overall health in each response group appear to be similar across both years.
